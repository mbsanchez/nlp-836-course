...
public class SpamLord {
  ...
  private Pattern emailPattern1 = Pattern.compile("([_A-Za-z0-9-]+(\\.[_A-Za-z0-9-]+)*)( ?)@( ?)([A-Za-z0-9]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,4}))", Pattern.CASE_INSENSITIVE);
  private Pattern emailPattern2 = Pattern.compile("([_A-Za-z0-9-]+(( dot |[;\\.]| dom | dt )[_A-Za-z0-9-]+)*)( at | where |\\(at\\))([A-Za-z0-9]+(( dot |[;\\.]| dom | dt )[A-Za-z0-9]+)*(( dot |[;\\.]| dom | dt )[A-Za-z]{2,4}))", Pattern.CASE_INSENSITIVE);
  private Pattern emailPattern3 = Pattern.compile("<em>([_A-Za-z0-9-]+(\\.[_A-Za-z0-9-]+)*)&#x40;([A-Za-z0-9]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,4}))</em>", Pattern.CASE_INSENSITIVE);
  private Pattern emailPattern4 = Pattern.compile("<script( type=text/javascript)?> obfuscate\\('([A-Za-z0-9]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,4}))','([_A-Za-z0-9-]+(\\.[_A-Za-z0-9-]+)*)'\\); </script>", Pattern.CASE_INSENSITIVE);
  private Pattern emailPattern5 = Pattern.compile("([_A-Za-z0-9-]+(\\.[_A-Za-z0-9-]+)*) \\(followed by (\"|&ldquo;)@([A-Za-z0-9]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,4}))(\"|&rdquo;)\\)", Pattern.CASE_INSENSITIVE);
  private Pattern emailPattern6 = Pattern.compile("(([_A-Za-z0-9]+-)+(\\.([_A-Za-z0-9]+-)+)*)@([A-Za-z0-9-]+(\\.([_A-Za-z0-9]+-)+)*(\\.[A-Za-z-]{3,7}[A-Za-z]))", Pattern.CASE_INSENSITIVE);
  private Pattern emailPattern7 = Pattern.compile("email: (([_A-Za-z0-9-]+(( dot |[;\\.]| dom | dt | )[_A-Za-z0-9-]+)*)( at | where |\\(at\\))([A-Za-z0-9]+(( dot |[;\\.]| dom | dt | )[A-Za-z0-9]+)*(( dot |[;\\.]| dom | dt | )[A-Za-z]{2,4})))", Pattern.CASE_INSENSITIVE);
  private Pattern numberPatter = Pattern.compile("(\\(([0-9]{3})\\)[ \\u00A0]?|([0-9]{3})([\\- \\u00A0.]|&thinsp;))([0-9]{3})([\\- \\u00A0.]|&thinsp;)([0-9]{4})");
  ...
  public List<Contact> processFile(String fileName, BufferedReader input) {
    ...
    try {
      for(String line = input.readLine(); line != null; line = input.readLine()) {
        m = emailPattern1.matcher(line);
        while(m.find()) {
          email = m.group(1) + "@" + m.group(5);
          Contact contact = new Contact(fileName,"e",email);
          contacts.add(contact);
        }
        
        line = line.replaceAll("<address>.*([Aa]pache|[Pp]ort).*</address>", "");
        m = emailPattern2.matcher(line);
        while(m.find()) {
          email = m.group(0); //m.group(1) + "@" + m.group(5);
          email = email.replaceAll(" at | WHERE | where |\\(at\\)", "@");
          email = email.replaceAll(" dot |;| dom | DOM | dt ", ".");
          email = email.replaceAll(" ", "");
          Contact contact = new Contact(fileName,"e",email);
          contacts.add(contact);
        }
        
        m = emailPattern3.matcher(line);
        while(m.find()) {
        ...
        m = emailPattern4.matcher(line);
        while(m.find()) {
          email =m.group(5) + "@" + m.group(2);
          Contact contact = new Contact(fileName,"e",email);
          contacts.add(contact);
        }
        
        m = emailPattern5.matcher(line);
        while(m.find()) {
          email =m.group(1) + "@" + m.group(4);
          Contact contact = new Contact(fileName,"e",email);
          contacts.add(contact);
        }
        
        m = emailPattern6.matcher(line);
        while(m.find()) {
          email = m.group(1) + "@" + m.group(5);
          email = email.replaceAll("-", "");
          Contact contact = new Contact(fileName,"e",email);
        ...
        m = numberPatter.matcher(line);
        while(m.find()){
            number = (m.group(2)!=null?m.group(2)+"-":"")+(m.group(3)!=null?m.group(3)+"-":"")+m.group(5)+"-"+m.group(7);
           //System.out.println(number);
            contacts.add(new Contact(fileName, "p", number));
        }
        
        m = emailPattern7.matcher(line);
        while(m.find()) {
          email = m.group(1); //m.group(1) + "@" + m.group(5);
          email = email.replaceAll(" at | WHERE | where |\\(at\\)", "@");
          email = email.replaceAll(" dot |;| dom | DOM | dt ", ".");
          email = email.replaceAll(" ", ".");
          Contact contact = new Contact(fileName,"e",email);
